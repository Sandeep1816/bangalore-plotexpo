...
<div className="flex flex-col items-start ">
  <div className=" p-3 rounded  mb-4 ">
    <img
      src="/images/bpe-logo.png" // Replace with your actual logo path
      alt="BPE Logo"
      className="h-18 w-auto object-contain mt-0"
    />
  </div>
</div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/conference" className="hover:text-green-200">
                  Conference
                </Link>
              </li>
              <li>
                <Link href="/exhibition" className="hover:text-green-200">
                  Exhibition
                </Link>
              </li>
              <li>
                <Link href="/exhibitors" className="hover:text-green-200">
                  Exhibitors
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/registration" className="hover:text-green-200">
